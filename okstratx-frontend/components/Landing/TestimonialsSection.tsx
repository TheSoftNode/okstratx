...
//                                 <CarouselItem key={testimonial.id} className="md:basis-1/2 lg:basis-1/3 pl-4">
//                                     <div className="p-1">
//                                         <Card className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 hover:shadow-md transition-shadow overflow-hidden">
...
//                                                 </div>
//                                                 <div className="relative">
//                                                     <Quote className="absolute top-0 left-0 h-8 w-8 text-blue-100 dark:text-blue-900 -translate-x-2 -translate-y-2 opacity-50" />
//                                                     <p className="text-gray-700 dark:text-gray-300 pl-4 relative z-10">
//                                                         "{testimonial.testimonial}"
//                                                     </p>
//                                                 </div>
//                                             </CardContent>
...
//                         <div
//                             key={i}
//                             className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 text-center border border-blue-100 dark:border-blue-800/50"
//                         >
